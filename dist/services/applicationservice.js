...
var ApplicationService = (function () {
    function ApplicationService(_eventStore, _domainService) {
        if (_eventStore === void 0) { _eventStore = new eventstore_1.EventStore(); }
        if (_domainService === void 0) { _domainService = new domainservice_1.DomainService(_eventStore); }
